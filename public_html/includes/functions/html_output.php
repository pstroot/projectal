 ...
 */
  function zen_image_NEW($src, $alt = '', $width = '', $height = '', $parameters = '') {
    global $template_dir;
 ...
 */
 // UPDATED BY PAUL STROOT
  function zen_draw_hidden_field($name, $value = '', $parameters = '', $default = '') {
	...
	if ($default == $value) {
		 $field .=  "<SCRIPT> updateShirtBackground(activeCategoryID,'".$value."'); </SCRIPT>"; 
	}
    return $field;
  }
 ...
 */
  function zen_draw_pull_down_menu($name, $values, $default = '', $parameters = '', $required = false) {
    ...
    $field .= ' onchange="javascript:updateAttribute(this);"'; // ADDED BY PAUL STROOT
