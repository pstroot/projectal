...
$hasPrimaryAddress = ( $_SESSION['customer_default_address_id'] > 0 ) ? true : false;
$hasAddresses = (count($addressArray) == 0 || (count($addressArray) == 1 && trim($addressArray[0]['address']['street_address']) == "" && trim($addressArray[0]['address']['city']) == "")) ? false : true;
