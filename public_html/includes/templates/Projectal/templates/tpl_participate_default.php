 ...
 */
?>
<div class="centerColumn" id="participateDefault">
...
if (isset($_GET['action']) && ($_GET['action'] == 'success')) {
	...
	<h1><?= HEADING_TITLE_SUCCESS; ?></h1>
	 <div class="textBoxArrow" id="topBox"></div>
     <div class="content" id="participateContent" ><?php echo TEXT_SUCCESS; ?></div>
    <BR /><BR /><BR /><BR /><BR /><BR />
	...
	<?php if (DEFINE_PARTICIPATE_STATUS >= '1' and DEFINE_PARTICIPATE_STATUS <= '2') { ?>
    ...
    <?php if($isParticipant){	?>
   		<h3><?= ALREADY_A_PARTICIPANT_MESSAGE; ?></h3>
...
<link type="text/css" rel="Stylesheet" href="http://ajax.microsoft.com/ajax/jquery.ui/1.8.5/themes/redmond/jquery-ui.css" />
	...
	<?php 	
    echo zen_draw_form('participateForm', zen_href_link(FILENAME_PARTICIPATE, 'action=send'),"POST","id='participateForm' accept-charset='UTF-8'"); 
	...
	if ($messageStack->size('join') > 0) echo $messageStack->output('join'); ?>
	...
	<div class="alert" id="requiredInfoLabel"><?php echo FORM_REQUIRED_INFORMATION; ?></div>
    <div id="legend">Login Information</div>
...
<!-- **************************** END NEWSLETTERS *********************************** -->
   ...
   <!-- ../images/btn_join_projectal.jpg -->
	...
	<?php echo zen_image_submit(BUTTON_IMAGE_SUBMIT_BIG, BUTTON_SUBMIT_ALT); ?>    
