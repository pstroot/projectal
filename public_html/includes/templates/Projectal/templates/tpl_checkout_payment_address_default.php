...
<div class="centerColumnPadding">
    ...
    <div class="buttonRow forward"><?php echo zen_draw_hidden_field('action', 'submit'); ?>
    <input type="submit" value="<?php echo BUTTON_CONTINUE_ALT; ?>" title="<?php echo BUTTON_CONTINUE_ALT; ?>" class="fancybutton greenButton"/></div>
    <div class="buttonRow back"><?php echo TITLE_CONTINUE_CHECKOUT_PROCEDURE . '<br />' . TEXT_CONTINUE_CHECKOUT_PROCEDURE; ?></div>
    
    <?php
      if ($process == true) {
		?>
		<div class="buttonRow back"><?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '" class="fancybutton greenButton small">' . BUTTON_BACK_ALT . '</a>'; ?></div>
