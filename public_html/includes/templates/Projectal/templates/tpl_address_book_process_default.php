...
if (isset($_GET['delete'])) {
    ...
    if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
		?>
		<div class="buttonRow forward"><?php echo zen_draw_hidden_field('action', 'update') . zen_draw_hidden_field('edit', $_GET['edit']); ?>
         <input type="submit" class="fancybutton greenButton small" title="Submit the Information" value="<?php echo BUTTON_UPDATE_ALT; ?>" />
         </div>
		...
		?>
        <!-- modify the address book from the "My Account" Screen -->
        <div class="buttonRow forward">
        <?php echo zen_draw_hidden_field('action', 'process'); ?>
        <input type="submit" class="fancybutton greenButton small" title="Submit the Information" value="<?php echo BUTTON_SUBMIT_ALT; ?>" /></div>
        <div class="buttonRow back"><a href="<?php echo zen_back_link(true); ?>" class="fancybutton greenButton small"><?php echo BUTTON_BACK_ALT; ?></a></div>
        <?php
    }
}
