...
define('FILENAME_DEFINE_TERMS_OF_USE', 'define_terms_of_use');
...
define('FILENAME_JOIN', 'join');
define('FILENAME_DEFINE_JOIN', 'define_join');
define('FILENAME_INFO', 'info');
define('FILENAME_DEFINE_INFO', 'define_info');
define('FILENAME_PARTICIPATE', 'participate');
define('FILENAME_DEFINE_PARTICIPATE', 'define_participate');
define('FILENAME_HOW_IT_WORKS', 'how_it_Works');
define('FILENAME_DEFINE_HOW_IT_WORKS', 'define_how_it_works');
define('FILENAME_MEMBERSHIP', 'membership');
define('FILENAME_DEFINE_MEMBERSHIP', 'define_membership');
define('FILENAME_CUSTOMER_SERVICE', 'customer_service');
define('FILENAME_DEFINE_CUSTOMER_SERVICE', 'define_customer_service');
define('FILENAME_ABOUT_US', 'about_us');
define('FILENAME_DEFINE_ABOUT_US', 'define_about_us');
define('FILENAME_STORE', 'store');
define('FILENAME_DEFINE_STORE', 'define_store');
