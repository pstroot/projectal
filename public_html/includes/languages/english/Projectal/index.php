...
if (STORE_STATUS == '0') {
  ...
  define('TEXT_GREETING_GUEST', ''); // UPDATED BY PAUL STROOT
} else {
  //define('TEXT_GREETING_GUEST', 'Welcome, please enjoy our online showcase.');
  define('TEXT_GREETING_GUEST', 'Welcome, please enjoy our online showcase.'); // UPDATED BY PAUL STROOT
}
...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
  ...
  define('HEADING_TITLE', ''); // UPDATED BY PAUL STROOT
