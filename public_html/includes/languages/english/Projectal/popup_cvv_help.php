...
define('TEXT_CVV_HELP3', 'a CVV is a 3 or 4 Digit Card Verification Number on your Credit Card<br /><br />
                    For your safety and security, we require that you enter your card\'s verification number.<br /><br />
                    The verification number is a 3-digit number printed on the back of your card Visa, Mastercard or Discover card,
					or on the front of your American Express verification number is a 4-digit number printed on the front of your card.
                    It appears after and to the right of your card number.<br /><br />' .
                    zen_image(DIR_WS_TEMPLATE_ICONS . 'cvv2visa.gif') . " " . 
					zen_image(DIR_WS_TEMPLATE_ICONS . 'cvv2amex.gif'));
