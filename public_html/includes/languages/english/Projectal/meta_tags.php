...
// page title
define('TITLE', 'ProjectAl');

// Site Tagline
define('SITE_TAGLINE', '');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'tshirts, minneapolis, clothing, community, neighborhoods, St. Paul, Twin Cities, shirts, local business');

// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'We create original t-shirt designs for our favorite independent businesses throughout the Twin Cities. Proceeds from every tee are given back to our community.');
