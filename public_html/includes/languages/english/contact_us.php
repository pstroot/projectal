...
define('SEND_TO_CONTACT','customerservice@ProjectAl.com');
define('SEND_TO_CHARITY','charity@ProjectAl.com');
define('SEND_TO_SUGGEST_A_TEE','suggestatee@ProjectAl.com');
define('SEND_TO_CUSTOMER_SERVICE','customerservice@ProjectAl.com');
define('SEND_TO_BUGS','paul@dancingpaul.com');
