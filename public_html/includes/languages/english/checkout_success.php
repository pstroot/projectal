...
define('HEADING_TITLE', 'Thank You!');
...
define('TEXT_CHECKOUT_LOGOFF_CUSTOMER', 'Please click the Log Off link to ensure that your receipt and purchase information is not visible to the next person using this computer.');
