...
// shopping_cart box text in sideboxes/shopping_cart.php
  define('BOX_HEADING_SHOPPING_CART', 'Mini Cart');
...
// javascript messages
  ...
  define('ENTRY_TELEPHONE_NUMBER', 'Telephone: (Required only for international shipping.)');
  ...
  define('FORM_REQUIRED_INFORMATION', '<span class="alert">*</span> Required information');
...
// if this function doesn't exist, then this page is probably being called from an external source, so the following code is not needed;
if(function_exists("zen_href_link")){
///////////////////////////////////////////////////////////
