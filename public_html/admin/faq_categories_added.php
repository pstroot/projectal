...
<div class="popupContent">
    ...
    Thank You! <b><?=$name?></b> has been added as a F.A.Q category.<BR /><BR />
    
    <a href="javascript:parent.window.location = 'faq.php?id=<?=$id;?>';">Click here</a> to return to FAQ admin page<BR /><BR />
