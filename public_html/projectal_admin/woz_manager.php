 ...
 */
  ...
  function install_woz($path = '') {
    ...
    $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " VALUES ('', '" . TEXT_WOZ_INSTALL_STATUS_TITLE . "', 'WOZ_CONFIG_STATUS', 'true', '" . TEXT_WOZ_INSTALL_STATUS_INFO . "', " . $group_id . ", '0', NULL, now(), NULL, 'zen_cfg_select_option(array(\"true\", \"false\"),'),('', '" . WOZ_CONFIG_INFO . "', 'WOZ_CONFIG_INFO', '%3C%21--Do+not+delete+this+copyright+link%2Ftext%21+When+you+want+to+delete+it%2C+please+purchase+a+professional+edition.+Please+understand+that+I+spend+time+on+development.--%3E%3Cdiv+id%3D%22woz_footer%22+style%3D%22clear%3A+both%3B+text-align%3A+center%3B+font-size%3A+small%3B+display%3A+block%3B+visibility%3A+visible%3B%22%3E%3Ca+href%3D%22http%3A%2F%2Fwww.s-page.net%2Fproducts%2F62.html%22%3EWordPress+On+ZenCart%3C%2Fa%3E+%28C%29+%3Ca+href%3D%22http%3A%2F%2Fwww.s-page.net%2F%22%3ES-page%3C%2Fa%3E%3C%2Fdiv%3E', '', '6', '5', NULL, now(), NULL, ''),('', '" . TEXT_WOZ_CONFIG_ORDER_ID_TITLE . "', 'WOZ_CONFIG_ORDER_ID', '0', '" . TEXT_WOZ_CONFIG_ORDER_ID_INFO . "', " . $group_id . ", '10', NULL, now(), NULL, '')");
