		...
		<?php $c->show_video("http://player.vimeo.com/video/15507608", "325", "580") ?>	
                ...
                <div class="cdn-setup" style="max-width:1250px;">
                    ...
                    <div class="cdn-rounded">
                     ...
                     <li><img src="<?php  echo WP_PLUGIN_URL ?>/share-and-follow/images/blank.gif" height="72px" width="100px" alt="<?php echo $item['location']; ?> set" style="background-image:url(<?php  echo $c->_options['cdn']['data']['sets']['overview'] ?>);background-position:<?php echo $item['position']; ?>;background-repeat: no-repeat" />
