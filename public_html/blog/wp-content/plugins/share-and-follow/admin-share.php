                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <img src="<?php echo WP_PLUGIN_URL; ?>/share-and-follow/images/blank.gif" height="16px" width="16px" alt="<?php echo $siteToShow; ?>" style="background:transparent url(<?php echo WP_PLUGIN_URL; ?>/share-and-follow/default/16/sprite-16.png) no-repeat <?php echo str_replace(" ", "px ",$c->_allSites[$siteToShow]['sprites']['16']) ?>px" />
                                <?php } elseif ($siteToShow == 'post_rss'){?>
                                <img src="<?php echo WP_PLUGIN_URL; ?>/share-and-follow/images/blank.gif" height="16px" width="16px" alt="<?php echo $siteToShow; ?>" style="background:transparent url(<?php echo WP_PLUGIN_URL; ?>/share-and-follow/default/16/sprite-16.png) no-repeat <?php echo str_replace(" ", "px ",$c->_allSites['rss']['sprites']['16']) ?>px" />
                                <?php } ?>
